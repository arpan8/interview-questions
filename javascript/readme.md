...
## 3. Types of execution context in javascript ?
 - Global execution context: It is created when js code starts running, it represents the global scope and global object(e.g winf=dow in browser). The 'this' keyword mainly refers to the global object.
